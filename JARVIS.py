...
if __name__=='__main__':
    ...
    while True:
        ...
        if 'wikipedia' in statement:
            ...
            speak("I was built by Vansh Sharma AKA TechPsychotic")
            print("I was built by Vansh Sharma AKA TechPsychotic")
        ...
        elif 'initialise ultron' in statement:
            speak('I can answer to computational and geographical questions and what question do you want to ask now')
            question=takeCommand()
            app_id="T4PPYR-47T6VQ7GRP"
            client = wolframalpha.Client('T4PPYR-47T6VQ7GRP')
        ...
        elif 'switch app' in statement:
            py.hotkey('alt','tab')
        
        elif 'new' and 'desktop' in statement:
            py.hotkey('win','ctrl','d')
        
        elif 'switch' and 'desktop' in statement:
            py.hotkey('win','ctrl','right')

        elif 'switch' and 'back' in statement:
            py.hotkey('win','ctrl','left')
        
        elif 'escape' in statement:
            py.hotkey('esc')
        ...
        elif 'full screen' or 'f 11' in statement:
            py.hotkey('f11')    


        elif 'properties' in statement:
            py.hotkey('alt','enter')    

        elif 'refresh' in statement:
            py.press('f5')    

        elif 'space' in statement:
            py.press('space')    
